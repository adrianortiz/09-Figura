 ...
 *
 */
public class VCirculoPerimetro extends JFrame implements ActionListener {
	 ...
	 */
	public VCirculoPerimetro() {
		
		super.setTitle("Círculo Perímetro");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == btnCalcular) {
			...
			lbResult.setText(String.format("%f", circulo.perimetro(parameters)));
