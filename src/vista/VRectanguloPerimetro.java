 ...
 *
 */
public class VRectanguloPerimetro extends JFrame implements ActionListener {
	 ...
	 */
	public  VRectanguloPerimetro(){
		super.setTitle("Rectangulo Perímetro");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == btncalcular) {
			...
			lbResult.setText(String.format("%f", recta.perimetro(parameters)));
		}
