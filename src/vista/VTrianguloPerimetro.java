 ...
 *
 */
public class VTrianguloPerimetro extends JFrame implements ActionListener {
	 ...
	 */
	public VTrianguloPerimetro() {
		super.setTitle("Triangulo Perímetro");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==btncalcular) {
			...
			parameters[2] = Double.parseDouble(txtlado3.getText());
			
			lbResult.setText(String.format("%f", trian.perimetro(parameters)));
		}
